<?php
    ...
    $sql = $conn->prepare("SELECT * FROM `leaves` WHERE `status` <> 'pending'");
    $sql->execute();
    ...
    <div class="container">
      <section class="vh-100 gradient-custom">
        <div class="btn-group   justify-content-center d-flex  mt-3 " role="group">
          ...
          <a href="#" class=" text-decoration-none p-3 btn-outline-primary active">History</a>
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                              ...
                              <div class="accordion-body">
                                  <div class="d-flex justify-content-between text-center justify-content-center">
                                    <div class="">
                                      <p>Applied on</p><strong>'.$item['created_at'].'</strong>
                                    </div>
